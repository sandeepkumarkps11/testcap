...
public class TC008_RecentTransactionDelete extends AppSpecificMethods{
	
	@BeforeTest
	public void setData() {
		testCaseName = "TC006_RecentTransaction_Edit";
		...
		try {
			...
			//Click on Receive Icon, Select Supplier & Purchase Order
				...
				if(testresult==true)
				{
					...
					jse.executeScript("browserstack_executor: {\"action\": \"setSessionStatus\", \"arguments\": {\"status\": \"passed\", \"reason\": \"TC008_RecentTransactionDelete Pass\"}}");
				}
				
		} catch (Exception e) {
			// TODO Auto-generated catch block
			jse.executeScript("browserstack_executor: {\"action\": \"setSessionStatus\", \"arguments\": {\"status\":\"failed\", \"reason\": \"TC008_RecentTransactionDelete Failed\"}}");
			e.printStackTrace();
		}
