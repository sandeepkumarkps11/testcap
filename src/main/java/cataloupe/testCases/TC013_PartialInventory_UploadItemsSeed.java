...
public class TC013_PartialInventory_UploadItemsSeed extends AppSpecificMethods{
	
	@BeforeTest
	public void setData() {
		testCaseName = "TC013_PartialInventory_UploadItemsSeed";
		testDescription = "PartialInventory_UploadItemsSeed";
		...
		try {
			...
			//Select the Operator
				...
				if(testresult==true)
				{
					...
					jse.executeScript("browserstack_executor: {\"action\": \"setSessionStatus\", \"arguments\": {\"status\": \"passed\", \"reason\": \"TC013_PartialInventory_UploadItemsSeed Pass\"}}");
				}
				
		} catch (Exception e) {
			// TODO Auto-generated catch block
			jse.executeScript("browserstack_executor: {\"action\": \"setSessionStatus\", \"arguments\": {\"status\":\"failed\", \"reason\": \"TC013_PartialInventory_UploadItemsSeed Failed\"}}");
			e.printStackTrace();
		}
