...
public class TC015_TransferModuleFlowNeagtiveFlow extends AppSpecificMethods{
	
	@BeforeTest
	public void setData() {
		testCaseName = "TC015_TransferModuleFlowNeagtiveFlow";
		testDescription = "TransferModuleFlowNeagtiveFlow";
		testNodes = "TransferModuleFlowNeagtiveFlow";
		authors = "Saurabh";
		category = "Functional";
		dataSheetName = "TC001";
	}
	...
	public void TransferModuleFlowNeagtiveFlow(String email, String pwd,String Operator,String warehouse,String Supplier) {
		...
		try {
			...
			//Select the Operator
				...
				new TransferModule()
				.clickTransfer()
				.verifyToWarehouseError()
				.clickToWarehouse()
				.SelectWarehouse()
				.verifyFromWarehouseError()
				.verifyFromToWarehouseError();
				
				testresult=true;
				if(testresult==true)
				{
					
					jse.executeScript("browserstack_executor: {\"action\": \"setSessionStatus\", \"arguments\": {\"status\": \"passed\", \"reason\": \"TC015_TransferModuleFlowNeagtiveFlow Pass\"}}");
				}
				
		} catch (Exception e) {
			// TODO Auto-generated catch block
			jse.executeScript("browserstack_executor: {\"action\": \"setSessionStatus\", \"arguments\": {\"status\":\"failed\", \"reason\": \"TC015_TransferModuleFlowNeagtiveFlow Failed\"}}");
			e.printStackTrace();
		}
