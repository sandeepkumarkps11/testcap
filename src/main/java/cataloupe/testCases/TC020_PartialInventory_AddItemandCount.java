...
public class TC020_PartialInventory_AddItemandCount extends AppSpecificMethods{
	
	@BeforeTest
	public void setData() {
		testCaseName = "TC020_PartialInventory_AddItemandCount";
		testDescription = "PartialInventory_AddItemandCount";
		testNodes = "PartialInventory_AddItemandCount";
		authors = "Saurabh";
		category = "Functional";
		dataSheetName = "TC001";
	}
				 ...
				 if(testresult==true)
				    {
					 ...
					 jse.executeScript("browserstack_executor: {\"action\": \"setSessionStatus\", \"arguments\": {\"status\": \"passed\", \"reason\": \"TC020_PartialInventory_AddItemandCount Pass\"}}");
				    }
				
		} catch (Exception e) {
			// TODO Auto-generated catch block
			jse.executeScript("browserstack_executor: {\"action\": \"setSessionStatus\", \"arguments\": {\"status\":\"failed\", \"reason\": \"TC020_PartialInventory_AddItemandCount not Pass\"}}");
			e.printStackTrace();
		}
