...
public class TC021_FullInventory_AddItemandCount extends AppSpecificMethods{
	
	@BeforeTest
	public void setData() {
		testCaseName = "TC021_FullInventory_AddItemandCount";
		testDescription = "FullInventory_AddItemandCount";
		testNodes = "FullInventory_AddItemandCount";
		authors = "Saurabh";
		category = "Functional";
		dataSheetName = "TC001";
	}
				 ...
				 if(testresult==true)
				    {
					 ...
					 jse.executeScript("browserstack_executor: {\"action\": \"setSessionStatus\", \"arguments\": {\"status\": \"passed\", \"reason\": \"TC021_FullInventory_AddItemandCount Pass\"}}");
				    }
		} catch (Exception e) {
			// TODO Auto-generated catch block
			jse.executeScript("browserstack_executor: {\"action\": \"setSessionStatus\", \"arguments\": {\"status\":\"failed\", \"reason\": \"TC021_FullInventory_AddItemandCount not Pass\"}}");
			e.printStackTrace();
		}
