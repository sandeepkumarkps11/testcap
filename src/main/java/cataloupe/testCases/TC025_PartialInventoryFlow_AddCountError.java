...
public class TC025_PartialInventoryFlow_AddCountError extends AppSpecificMethods{
	
	@BeforeTest
	public void setData() {
		testCaseName = "TC025_PartialInventoryFlow_AddCountError";
		testDescription = "PartialInventoryFlow_AddCountError";
		testNodes = "PartialInventoryFlow_AddCountError";
		authors = "Saurabh";
		category = "Functional";
		dataSheetName = "TC001";
	}
		...
		try {
			...
			//Select the Operator
				...
				if(testresult==true)
			    {
				 ...
				 jse.executeScript("browserstack_executor: {\"action\": \"setSessionStatus\", \"arguments\": {\"status\": \"passed\", \"reason\": \"TC025_PartialInventoryFlow_AddCountError Pass\"}}");
			    }
				
		} catch (Exception e) {
			// TODO Auto-generated catch block
			jse.executeScript("browserstack_executor: {\"action\": \"setSessionStatus\", \"arguments\": {\"status\":\"failed\", \"reason\": \"TC025_PartialInventoryFlow_AddCountError not Pass\"}}");
			e.printStackTrace();
		}
