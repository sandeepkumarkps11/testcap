...
public class TC029_FullInventory_UploadItemsSeedwithoutInternet extends AppSpecificMethods{
	
	@BeforeTest
	public void setData() {
		testCaseName = "TC029_FullInventory_UploadItemsSeedwithoutInternet";
		testDescription = "FullInventory_UploadItemsSeedwithoutInternet";
		testNodes = "FullInventory_UploadItemsSeedwithoutInternet";
		authors = "Saurabh";
		category = "Functional";
		dataSheetName = "TC001";
	}
		...
		try {
			...
			//Select the Operator
				...
				if(testresult==true)
			    {
				 ...
				 jse.executeScript("browserstack_executor: {\"action\": \"setSessionStatus\", \"arguments\": {\"status\": \"passed\", \"reason\": \"TC029_FullInventory_UploadItemsSeedwithoutInternet Pass\"}}");
			    }
		} catch (Exception e) {
			// TODO Auto-generated catch block
			jse.executeScript("browserstack_executor: {\"action\": \"setSessionStatus\", \"arguments\": {\"status\":\"failed\", \"reason\": \"TC029_FullInventory_UploadItemsSeedwithoutInternet not Pass\"}}");
			e.printStackTrace();
		}
